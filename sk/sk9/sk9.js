const sk9 = sk => {
  ...
  sk.mousePressed = () => {
    for (let i = 0; i < 11; i++) {
      heads[i].x = sk.random(0.1, sk.windowWidth)
      heads[i].xOfst = sk.random(0.1, sk.windowWidth)
      heads[i].y = sk.random(0.1, sk.windowHeight)
      heads[i].yOfst = sk.random(0, sk.windowHeight)
      heads[i].w = sk.random(0.1, sk.windowHeight * 0.2)
      heads[i].h = sk.random(0.1, sk.windowHeight * 0.2)
      heads[i].wB = sk.random(0.1, sk.windowHeight * 0.2)
      heads[i].hB = sk.random(0.11, sk.windowHeight * 0.2)
  ...
  Heads = function () {
    this.x = sk.random(0.1, sk.windowWidth)
    this.xOfst = sk.random(0.1, sk.windowWidth)
    this.y = sk.random(0.1, sk.windowHeight)
    this.yOfst = sk.random(0, sk.windowHeight)
    this.w = sk.random(sk.windowHeight * 0.01, sk.windowHeight * 0.2)
    this.h = sk.random(sk.windowHeight * 0.01, sk.windowHeight * 0.2)
    this.wB = sk.random(sk.windowHeight * 0.01, sk.windowHeight * 0.2)
    this.hB = sk.random(sk.windowHeight * 0.01, sk.windowHeight * 0.2)
