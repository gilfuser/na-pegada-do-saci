  ...
  sk.setup = () => {
    ...
    for (let i = 0; i < cols; i++) {
      ...
      for (let j = 0; j < rows; j++) {
        w = random(windowHeight / (rows * 4), windowHeight / (rows * 2))
        h = random(windowHeight / (rows * 4), windowHeight / (rows * 2))
  ...
  function Heads2 (w, h, x, y) {
    ...
    this.display = function () {
      ...
      if (
        ...
        this.cor = sk.color(random(57, 256), sk.random(23, 98), 0, 10)
